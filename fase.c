...
static void cozinha(Fase* f)
{
    ...
    objeto(f,864,96,275,251,885,150,.96,.04,.52,.92,.46,true,true,true,2,2);
    objeto(f,1164,14,234,363,1115,135,.98,.04,.56,.92,.42,true,true,true,2,3);
    objeto(f,55,401,341,380,230,430,.94,.05,.47,.90,.51,true,true,true,2,4);
    objeto(f,838,396,160,385,790,425,.94,.04,.45,.92,.53,true,true,true,2,5);
    objeto(f,451,615,192,243,105,710,.88,.04,.52,.92,.46,true,true,true,2,6);
    objeto(f,700,708,105,124,990,730,.88,.10,.48,.80,.48,true,false,false,2,7);
    objeto(f,1000,667,81,203,1115,690,.90,.17,.72,.66,.25,false,false,false,1,8);
    objeto(f,240,817,177,241,1160,750,.82,.15,.68,.70,.30,true,false,false,2,9);
...
static void banheiro(Fase* f)
{
    ...
    objeto(f,1022,275,176,240,1060,500,.90,.05,.48,.90,.50,true,true,false,2,4);
    objeto(f,1230,300,198,200,1200,520,.82,.05,.46,.90,.52,true,true,false,2,5);
    objeto(f,42,501,397,410,90,590,.83,.03,.50,.94,.48,true,true,true,2,6);
    objeto(f,558,546,176,163,720,665,.78,.06,.40,.88,.58,true,false,false,2,7);
